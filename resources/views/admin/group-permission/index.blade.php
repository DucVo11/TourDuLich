                            ...
                            <table class="table table-hover text-nowrap table-bordered">
                                ...
                                <tbody>
                                    @if (!$permissionGroups->isEmpty())
                                        @php $i = $permissionGroups->firstItem(); @endphp
                                        @foreach($permissionGroups as $permissionGroup)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary btn-sm" href="{{ route('group.permission.update', $permissionGroup->id) }}">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm btn-delete btn-confirm-delete" href="{{ route('group.permission.delete', $permissionGroup->id) }}">
